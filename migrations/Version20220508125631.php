 ...
 */
final class Version20220508125631 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP SEQUENCE comment_element_id_seq CASCADE');
        ...
        $this->addSql('CREATE TABLE comment (id INT NOT NULL, author_id INT DEFAULT NULL, product_id INT DEFAULT NULL, title VARCHAR(255) NOT NULL, rate INT NOT NULL, content TEXT NOT NULL, PRIMARY KEY(id))');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE SEQUENCE comment_element_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
